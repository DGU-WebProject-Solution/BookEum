...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="bookdetailno.css">
</head>
<body>
    <!-- Sidebar -->
    <div class="sidebar">
    ...
    <div class="sidebar-right">
        ...
        <div class="my-book">
            <div class="dropdown-wrapper"><h2>내가 교환할 책</h2></div>
            <div class="label">교환할 책을 등록해주세요</div>
            <div class="book-button">
                <button class="chat-button">등록하기</button>
            </div>
        </div>
    </div>
