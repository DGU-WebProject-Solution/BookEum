...
<%
    ...
    <div class="main-wrapper">
        ...
        <div class="main-content">
            <!-- Header -->
            <div class="header">
                <img src="./images/search.png" alt="search"><input type="text" placeholder="내가 읽고 싶었던 책을 검색해보세요!">
            </div>
    ...
    <div class="sidebar-right">
        ...
        <div class="recommendbook">
            ...
            <p class="book-description">사람들은 타인에 대해 이야기하는 것을 좋아한다. 단순히 이야기하는 것을 넘어서 서슴지 않게 평가를 하기도 한다. 한 개인을 평가하는 여러 척도가 있을 텐데 아마 성격은 가장 중요한 척도 중 하나가 아닐까.</p>
        </div>
